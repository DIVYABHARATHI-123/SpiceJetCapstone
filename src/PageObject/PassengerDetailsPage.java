...
public class PassengerDetailsPage extends BaseClass {
	...
	public void bookFlight() throws InterruptedException {
		...
		title.click();
		titleSelect.click();
		firstName.sendKeys("Divyabharathi");
		lastname.sendKeys("Vishal");
		phone.sendKeys("8124394266");
		email.sendKeys("dbharathi11997@gmail.com");
		city.sendKeys("CJB");
		...
		cardNumber.sendKeys("3005 0012 6318 4238");
		nameoncard.sendKeys("Divyabharathi");
	...
	public void passengerDetails() throws InterruptedException {
		...
		lastname.sendKeys("Sivam");
		phone.sendKeys("7845994236");
		email.sendKeys("Revathysivam1996@gmail.com");
		city.sendKeys("CJB");
		primarycustomerCheckbox.click();
		scroll();
		passenger2.click();
		NamePassenger2.sendKeys("Udaya");
		lastNamePassenger2.sendKeys("Kuamr");
		phonePassenger2.sendKeys("9094738973");
		scroll();
		Passenger3.click();
